...
$jobid = $db->select_uniquejobid();

$add_jobposts = $db->add_jobposts($userid,$jobid,$job_title,$job_type,$expiry_date,$job_category,$job_designation,$job_salary,$job_experience,$job_qualification,$job_vacancy,$job_location,$job_eligibility,$job_gender,$job_desc,$job_perks,$job_musthave,$job_qts1,$job_qts2,$job_skillstring);
