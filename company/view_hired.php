...
$get_hired_candidates_only = $db->get_hired_candidates_only($jobid);
if($get_hired_candidates_only)
{
foreach($get_hired_candidates_only as $prow)
{
	...
	foreach($get_resumedetails as $row)
	{
		...
		echo '<div class="col-md-12" style="border:1px solid #D3D3D3;padding-top:20px;padding-bottom:20px; border-radius: 10px;">
			<div class="col-md-9">
				...
				echo'<br><i class="fa fa-envelope" style="color:orange;" aria-hidden="true"></i> '.$resume_email.'</span><br><i class="fa fa-phone" style="color:blue;" aria-hidden="true"></i> '.$resume_mobile.'</p><span style="font-weight:bold;">Skills </span>';
...
function shortlist_candidate(cand_userid,jobid)
{
	$.ajax({
		type: "POST",
