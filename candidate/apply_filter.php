...
//echo $category."<br/>".$location."<br/>".$type."<br/>";
...
$get_alljobs_filtered = $db->get_alljobs_filtered($category,$location,$type);

echo '<div class="col-md-7 well">';
	if($get_alljobs_filtered)
	{
		foreach($get_alljobs_filtered as $prow)
		{
